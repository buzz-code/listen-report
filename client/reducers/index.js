...
import {
  ...
  TEXTS,
  STUDENT_REPORTS,
  TEACHER_SALARY_REPORTS,
  TEACHER_SALARY_SUMMARY_REPORTS,
  TEACHER_REPORTS,
  ORGANIATION_REPORTS,
  DAILY_REPORTS,
  MONTHLY_REPORTS,
...
const appReducer = (history) =>
  combineReducers({
    ...
    [TEACHER_SALARY_REPORTS]: crudReducer(TEACHER_SALARY_REPORTS),
    [TEACHER_SALARY_SUMMARY_REPORTS]: crudReducer(TEACHER_SALARY_SUMMARY_REPORTS),
