...
const getFilters = () => [
  ...
  { field: 'watched_lessons', label: 'שיעורי צפיה', type: 'text', operator: 'like' },
];

const ReportKindergartenContainer = ({ entity, title }) => {
...
export default ReportKindergartenContainer;
